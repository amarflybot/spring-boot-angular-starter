[![Build Status](https://travis-ci.org/amarraja123/spring-boot-maven-angular-starter.svg?branch=master)](https://travis-ci.org/amarraja123/spring-boot-maven-angular-starter)
